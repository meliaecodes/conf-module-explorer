...
const App = () => {
  ...
  return (
    <>
      ...
      <Text>View <Link href="https://developer.atlassian.com/platform/forge/manifest-reference/modules/confluence-space-settings" openNewTab="true">Space settings</Link> docs on Atlassian Developers</Text>
    </>
  );
};
