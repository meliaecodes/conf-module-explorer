...
const App = () => {
  ...
  return (
    <>
      ...
      <Text>View <Link href="https://developer.atlassian.com/platform/forge/manifest-reference/modules/homepage-feed" openNewTab="true">Homepage feed</Link> docs on Atlassian Developers</Text>
    </>
  );
};
