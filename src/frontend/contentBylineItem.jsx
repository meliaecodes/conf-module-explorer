...
const App = () => {
  ...
  return (
    <>
      ...
      <Text>View <Link href="https://developer.atlassian.com/platform/forge/manifest-reference/modules/confluence-content-byline-item/" openNewTab="true">Content byline item</Link> docs on Atlassian Developers</Text>
    </>
  );
};
