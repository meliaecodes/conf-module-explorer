...
const App = () => {
  ...
  return (
    <>
      ...
      <Text><Strong>isEditing</Strong> {context ? context.extension.isEditing.toString() : 'Loading...'} </Text>
      <Text>View <Link href="https://developer.atlassian.com/platform/forge/manifest-reference/modules/macro" openNewTab="true">Macro</Link> docs on Atlassian Developers</Text>
    </>
  );
};
