...
const App = () => {
  ...
  return (
    <>
      ...
      <Text>View <Link href="https://developer.atlassian.com/platform/forge/manifest-reference/modules/confluence-global-settings" openNewTab="true">Global settings</Link> docs on Atlassian Developers</Text>
    </>
  );
};
